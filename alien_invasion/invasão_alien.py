...
def run_game():
    ...
    # som do tiro da nave herói
    som_tiro = pygame.mixer.Sound("/home/marco_user/Documentos/Projetos/Python_ProjetoLivro/audio/disparo.ogg")

    # inicializado pontos do jogo como string
    pontos = str(0)
    ...
    while True:
        jf.check_eventos(ai_configuracoes, tela, estatistica, rp, play_button, nave, aliens, municoes, som_tiro)
        ...
        if estatistica.game_active:
            ...
            jf.update_municoes(ai_configuracoes, tela, nave, municoes, aliens, estatistica, rp, som_tiro)
            # Update da frota
